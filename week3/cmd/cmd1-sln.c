 ...
 * mario.c
 * *
 * Prints out a half pyramid with a user-supplied height. (Solution)
 *
 * Modified to take a command line argument instead of using GetInt()
 * 
 * =+ 
 * 
 * Thanks to Nate Hardison
 */
...
int main(int argc, string argv[])
{
    ...
    // get the height from the first argument and convert it to an integer (why???)
